...
class NotificationComponent < ApplicationComponent
  ...
  STYLES = {
    ...
    secondary: {
      notice: 'bg-blue-50 text-blue-500 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5 hover:bg-blue-200 inline-flex items-center justify-center dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700',
